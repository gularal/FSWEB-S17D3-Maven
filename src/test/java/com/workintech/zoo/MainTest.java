...
class MainTest {
    ...
    private Kangaroo.Koala koala;

    @BeforeEach
    void setup() {

        kangaroo = new Kangaroo(1, "Kenny", 2.0, 85.0, "Male", false);
        koala = new Kangaroo.Koala(1, "Kara", 20.0, 15.0, "Female");
    ...
    void testKoalaAllArgsConstructor() {
        ...
        Kangaroo.Koala koala = new Kangaroo.Koala(1, "Kara", 20.0, 15.0, "Female");
    ...
    void testKoalaSettersAndGetters() {
        ...
        Kangaroo.Koala koala = new Kangaroo.Koala();
        koala.setId(2);
        koala.setName("Kody");
